...
const Checkout: React.FC = () => {
  ...
  return (
    <main className="layout-container flex-1 w-full px-6 lg:px-40 py-8 flex justify-center">
        <div className="layout-content-container max-w-[1200px] w-full">
            {/* Page Heading */}
            <div className="mb-10">
                            ...
                            <label className="relative cursor-pointer group" onClick={() => setShippingMethod('standard')}>
                                ...
                                <div className="p-5 rounded-2xl bg-card-dark border border-secondary/20 peer-checked:border-primary peer-checked:bg-primary/5 transition-all h-full">
                                    <div className="flex justify-between items-start mb-2">
                                        ...
                                        <div className="w-5 h-5 rounded-full border border-slate-500 peer-checked:border-primary peer-checked:bg-primary flex items-center justify-center">
                    ...
                    <div className="sticky top-24 bg-card-dark rounded-3xl border border-white/5 overflow-hidden shadow-2xl shadow-black/50">
                        <div className="p-6 md:p-8 flex flex-col gap-6">
                            ...
                            <button 
                                ...
                                className="group relative w-full h-14 rounded-full overflow-hidden mt-2 glow-hover transition-all duration-300 shadow-[0_0_15px_rgba(233,32,99,0.3)] hover:shadow-[0_0_25px_rgba(233,32,99,0.5)]"
                            >
