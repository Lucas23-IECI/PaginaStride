      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="flex flex-col h-full justify-center">
          <nav className="flex mb-4 text-sm text-gray-400 gap-2">
            ...
            <a className="hover:text-white transition-colors" href="#">Mujer</a> / 
            <span className="text-primary">{product.category}</span>
          </nav>
          
          <h1 className="text-4xl lg:text-5xl font-bold font-display text-white mb-4 tracking-tight">{product.name}</h1>
          
          <div className="flex items-center justify-between mb-8 pb-8 border-b border-white/10">
            <div className="flex flex-col">
              <span className="text-3xl font-bold text-price-gold">${product.price.toLocaleString('es-CL')}</span>
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4">
              <button 
                ...
                className="w-full h-16 bg-gradient-primary rounded-full text-white font-bold text-lg uppercase tracking-wide shadow-[0_10px_40px_-10px_rgba(233,32,99,0.5)] hover:shadow-[0_20px_60px_-15px_rgba(233,32,99,0.6)] hover:scale-[1.01] active:scale-[0.98] transition-all flex items-center justify-center gap-3"
              >
