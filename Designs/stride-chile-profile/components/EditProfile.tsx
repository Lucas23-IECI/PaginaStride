...
export const EditProfile: React.FC<EditProfileProps> = ({ onChangeView }) => {
  return (
    <div className="bg-background-dark font-display text-white antialiased min-h-screen">
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 frosted-glass transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <a href="#" onClick={(e) => { e.preventDefault(); onChangeView('dashboard'); }} className="group relative">
      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-8">
            <button onClick={() => onChangeView('dashboard')} className="hover:text-primary transition-colors">
              Inicio
            </button>
          ...
          <form className="space-y-8" onSubmit={(e) => { e.preventDefault(); onChangeView('dashboard'); }}>
            <div className="bg-surface-dark rounded-2xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    className="w-full bg-background-dark border-white/10 rounded-xl px-4 py-3 text-white transition-all focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none"
                    type="text"
                    defaultValue="Nicolas Silva"
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <input
                    className="w-full bg-background-dark border-white/10 rounded-xl px-4 py-3 text-white transition-all focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none"
                    type="text"
                    defaultValue="Concepción, Chile"
                  />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-semibold text-gray-400 ml-1">Biografía</label>
                  <textarea
                    className="w-full bg-background-dark border-white/10 rounded-xl px-4 py-3 text-white transition-all resize-none focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none"
                    placeholder="Cuéntanos sobre tu pasión por el running..."
                    rows={3}
                    defaultValue="Amante de los cerros y los kilómetros en buena compañía. Entrenando para mi primera maratón."
                  ></textarea>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface-dark rounded-2xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select className="w-full bg-background-dark border-white/10 rounded-xl px-4 py-3 text-white transition-all appearance-none focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full bg-background-dark border-white/10 rounded-xl pl-10 pr-4 py-3 text-white transition-all focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none"
                      placeholder="usuario"
                      type="text"
                    />
                  </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-end gap-4 pt-4">
              <button
                className="w-full sm:w-auto px-8 py-4 border-2 border-white/10 text-white font-bold rounded-full hover:bg-white/5 hover:border-white/30 transition-all order-2 sm:order-1"
                type="button"
              ...
              <button
                className="w-full sm:w-auto px-10 py-4 bg-gradient-primary text-white font-black rounded-full shadow-[0_0_20px_rgba(233,32,99,0.3)] hover:shadow-[0_0_30px_rgba(233,32,99,0.5)] transform hover:scale-105 transition-all order-1 sm:order-2"
                type="submit"
              >
                Guardar Cambios
              </button>
            ...
            <div className="pt-8 text-center">
              <button className="text-red-500/60 hover:text-red-500 text-sm font-medium transition-colors" type="button">
                Eliminar mi cuenta
              </button>
            </div>
          </form>
