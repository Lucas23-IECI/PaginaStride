...
const Confirmation = () => {
    ...
    const orderNumber = useMemo(() => `ST-${Math.floor(1000 + Math.random() * 9000)}`, []);

    // Limpiar carrito cuando se abandona la página
    useEffect(() => {
        return () => clearCart();
    }, [clearCart]);
    ...
    return (
        <div className="flex-grow flex flex-col relative min-h-screen">
            ...
            <div className="relative z-20 container mx-auto px-4 py-12 md:px-6 lg:px-40 flex flex-col items-center pt-28">
                {/* Celebration Header */}
                <div className="text-center mb-10 max-w-4xl mx-auto">
                    ...
                    <p className="text-gray-300 text-lg md:text-xl font-medium tracking-wide">
                        Tu pedido <span className="text-white font-bold font-mono">#{orderNumber}</span> ha sido confirmado
                    </p>
                </div>
                ...
                <div className="w-full max-w-[800px] flex flex-col gap-6">
                    ...
                    <div className="bg-card-dark rounded-3xl overflow-hidden border border-primary/30 shadow-2xl relative group">
                        ...
                        <div className="bg-[#212c2e] p-6 flex justify-between items-center border-t border-[#283739]">
                            ...
                            <p className="text-2xl font-black text-white">${(total || 67970).toLocaleString('es-CL')}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <div className="bg-card-dark rounded-2xl p-6 border border-[#283739] flex flex-col items-center justify-center gap-3">
                            ...
                            <Link to="/" className="w-full h-12 bg-primary hover:bg-[#0bc1d3] text-background-dark font-bold text-lg rounded-full flex items-center justify-center gap-2 transition-colors shadow-[0_0_20px_rgba(19,218,236,0.4)] hover:shadow-[0_0_30px_rgba(19,218,236,0.6)]">
                                Ver Próximas Runs
