...
const CartDrawer = () => {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div className="fixed top-0 right-0 h-full w-full sm:w-[480px] bg-[#1a1a1a]/95 backdrop-blur-xl border-l border-white/5 shadow-2xl z-50 flex flex-col transform transition-transform duration-300 ease-out">
